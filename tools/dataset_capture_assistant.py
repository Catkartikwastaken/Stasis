...
class DatasetCaptureApp:
    ...
    def setup_style(self) -> None:
        ...
        self.style.configure("TFrame", background="#0f1512")
        self.style.configure("Panel.TFrame", background="#17231e")
        self.style.configure("Card.TFrame", background="#1d2b25", relief="flat")
        self.style.configure("TLabel", background="#0f1512", foreground="#e7f1ea", font=("Segoe UI", 10))
        self.style.configure("Panel.TLabel", background="#17231e", foreground="#e7f1ea", font=("Segoe UI", 10))
        self.style.configure("Muted.TLabel", background="#17231e", foreground="#aebdb5", font=("Segoe UI", 9))
        self.style.configure("Card.TLabel", background="#1d2b25", foreground="#e7f1ea", font=("Segoe UI", 10))
        self.style.configure("Section.TLabel", background="#17231e", foreground="#8bd17c", font=("Segoe UI Semibold", 10))
        self.style.configure("Title.TLabel", background="#17231e", foreground="#ffffff", font=("Segoe UI Semibold", 20))
        self.style.configure("Prompt.TLabel", background="#1d2b25", foreground="#ffcf5a", font=("Segoe UI Semibold", 15))
        self.style.configure("Hero.TLabel", background="#17231e", foreground="#ffffff", font=("Segoe UI Semibold", 16))
        self.style.configure("Big.TButton", font=("Segoe UI Semibold", 12), padding=(14, 11), background="#2f7d4f", foreground="#ffffff")
        self.style.map("Big.TButton", background=[("active", "#3e9962")])
        self.style.configure("TButton", font=("Segoe UI", 10), padding=(10, 7), background="#24362f", foreground="#e7f1ea")
        self.style.configure("TCombobox", padding=(6, 4))
        self.style.configure("Vertical.TScrollbar", background="#24362f", troughcolor="#101714", arrowcolor="#e7f1ea")
    ...
    def build_ui(self) -> None:
        ...
        side_canvas = tk.Canvas(side_shell, bg="#17231e", highlightthickness=0, bd=0)
